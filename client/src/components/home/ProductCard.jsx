...
const handleWishlist = (e) => {
  ...
  return (
    <Link to={`/product/${product._id}`}>
      ...
      <div className="w-full bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
...
<div className="p-5 text-center">
          ...
          <button
            ...
            className="mt-5 w-full bg-[#556B2F] text-white py-3 rounded-2xl hover:bg-[#445625] shadow-md transition"
          >
            Add to Cart
          </button>
